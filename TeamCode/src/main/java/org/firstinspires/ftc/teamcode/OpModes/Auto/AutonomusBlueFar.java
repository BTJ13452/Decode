...
public class AutonomusBlueFar extends OpMode {
    ...
    Command wait = waitMs(800);
    Command shortWait = waitMs(50);
    Command pickup1Timeout = waitMs(3500);
    Command pickup2Timeout = waitMs(7000);
    Command pickup3Timeout = waitMs(1200);
    Command pickup4Timeout = waitMs(1200);
    ...
    public void buildPaths() {
        ...
        scorePickup3 = follower.pathBuilder()
                .addPath(new BezierLine(pickup3BackPose, score3Pose))
        ...
        BackGrabPickup4 = follower.pathBuilder()
                .addPath(new BezierLine(pickup4Pose, pickup4BackPose))
                .setConstantHeadingInterpolation(pickup4BackPose.getHeading())
                .build();

        scorePickup4 = follower.pathBuilder()
                .addPath(new BezierLine(pickup4BackPose, score4Pose))
    ...
    public Command autoRoutine() {
        return sequential(
                ...
                race(
                        sequential(
                                follow(follower, grabPickup4, true),
                                startIntake
